...
class RbacController extends Controller {
    ...
    public function actionInit() {
        ...
        $viewAllPage = $auth->createPermission('viewAllPage');
        $viewAllPage->description = 'Просмотр all';
        ...
        $auth->addChild($superadmin,$admin, $editor);
        
        // Еще админ имеет собственное разрешение - «Просмотр админки»
        $auth->addChild($admin, $viewAdminPage);
        $auth->addChild($superadmin, $viewAllPage);
